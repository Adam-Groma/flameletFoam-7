...
#include "flameletConvectiveHeatTransferFvPatchScalarField.H"
...
flameletConvectiveHeatTransferFvPatchScalarField::
flameletConvectiveHeatTransferFvPatchScalarField
(
    const fvPatch& p,
...
flameletConvectiveHeatTransferFvPatchScalarField
(
    const flameletConvectiveHeatTransferFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
flameletConvectiveHeatTransferFvPatchScalarField
(
    const flameletConvectiveHeatTransferFvPatchScalarField& htcpsf
)
:
...
void flameletConvectiveHeatTransferFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void flameletConvectiveHeatTransferFvPatchScalarField::write(Ostream& os) const
{
