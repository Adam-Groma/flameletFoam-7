...
flameletThermalBaffle1DFvPatchScalarField<solidType>::
flameletThermalBaffle1DFvPatchScalarField
(
    const fvPatch& p,
...
flameletThermalBaffle1DFvPatchScalarField
(
    const flameletThermalBaffle1DFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
:
    ...
    qrRelaxation_(dict.lookupOrDefault<scalar>("qrRelaxation", 0)),
...
template<class solidType>
bool flameletThermalBaffle1DFvPatchScalarField<solidType>::owner() const
{
...
template<class solidType>
const solidType& flameletThermalBaffle1DFvPatchScalarField<solidType>::solid() const
{
    if (this->owner())
    {
        if (solidPtr_.empty())
    ...
    else
    {
        ...
        const flameletThermalBaffle1DFvPatchScalarField& nbrField =
        refCast<const flameletThermalBaffle1DFvPatchScalarField>
        (
...
template<class solidType>
tmp<scalarField> flameletThermalBaffle1DFvPatchScalarField<solidType>::
...
template<class solidType>
tmp<scalarField> flameletThermalBaffle1DFvPatchScalarField<solidType>::Qs() const
{
    if (this->owner())
    {
         return Qs_;
...
template<class solidType>
void flameletThermalBaffle1DFvPatchScalarField<solidType>::autoMap
(
...
template<class solidType>
void flameletThermalBaffle1DFvPatchScalarField<solidType>::rmap
(
...
)
{
    ...
    const flameletThermalBaffle1DFvPatchScalarField& tiptf =
        refCast<const flameletThermalBaffle1DFvPatchScalarField>(ptf);
...
template<class solidType>
void flameletThermalBaffle1DFvPatchScalarField<solidType>::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    if (baffleActivated_)
    {
        ...
        const compressible::flameletTurbulenceModel& turbModel =
            db().template lookupObject<compressible::flameletTurbulenceModel>
            (
...
template<class solidType>
void flameletThermalBaffle1DFvPatchScalarField<solidType>::write(Ostream& os) const
{
