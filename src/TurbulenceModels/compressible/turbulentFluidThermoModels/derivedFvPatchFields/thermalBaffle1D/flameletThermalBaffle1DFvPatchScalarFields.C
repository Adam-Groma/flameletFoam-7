...
#include "flameletThermalBaffle1DFvPatchScalarFields.H"
...
(
    ...
    "compressible::flameletThermalBaffle1D<hConstSolidThermoPhysics>",
    0
);
...
(
    ...
    "compressible::flameletThermalBaffle1D<hPowerSolidThermoPhysics>",
    0
);
