...
#include "flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField.H"
...
flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField::
flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField
(
    const fvPatch& p,
...
flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField
(
    const flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField
(
    const flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField& wtcsf,
    const DimensionedField<scalar, volMesh>& iF
)
:
    mixedFvPatchScalarField(wtcsf, iF),
    flameletTemperatureCoupledBase(patch(), wtcsf.KMethod(), wtcsf.kappaName()),
...
void flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    typedef flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField thisType;
...
void flameletTurbulentTemperatureCoupledBaffleMixedFvPatchScalarField::write
(
    Ostream& os
) const
{
