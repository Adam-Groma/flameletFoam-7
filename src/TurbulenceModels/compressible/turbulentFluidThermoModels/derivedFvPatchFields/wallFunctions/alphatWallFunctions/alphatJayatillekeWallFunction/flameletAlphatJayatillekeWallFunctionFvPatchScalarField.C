...
#include "flameletAlphatJayatillekeWallFunctionFvPatchScalarField.H"
...
scalar flameletAlphatJayatillekeWallFunctionFvPatchScalarField::maxExp_ = 50.0;
scalar flameletAlphatJayatillekeWallFunctionFvPatchScalarField::tolerance_ = 0.01;
label flameletAlphatJayatillekeWallFunctionFvPatchScalarField::maxIters_ = 10;

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

scalar flameletAlphatJayatillekeWallFunctionFvPatchScalarField::Psmooth
(
    const scalar Prat
) const
{
...
scalar flameletAlphatJayatillekeWallFunctionFvPatchScalarField::yPlusTherm
(
...
flameletAlphatJayatillekeWallFunctionFvPatchScalarField::
flameletAlphatJayatillekeWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
flameletAlphatJayatillekeWallFunctionFvPatchScalarField
(
    const flameletAlphatJayatillekeWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
flameletAlphatJayatillekeWallFunctionFvPatchScalarField
(
    const flameletAlphatJayatillekeWallFunctionFvPatchScalarField& awfpsf
)
:
...
void flameletAlphatJayatillekeWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
    ...
    const compressible::flameletTurbulenceModel& turbModel =
        db().lookupObject<compressible::flameletTurbulenceModel>
        (
            IOobject::groupName
            (
                compressible::flameletTurbulenceModel::propertiesName,
                internalField().group()
            )
        );
...
void flameletAlphatJayatillekeWallFunctionFvPatchScalarField::write(Ostream& os) const
{
