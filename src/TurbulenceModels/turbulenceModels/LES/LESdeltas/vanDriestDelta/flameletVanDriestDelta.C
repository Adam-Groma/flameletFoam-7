...
#include "flameletVanDriestDelta.H"
...
namespace LESModels
{
    defineTypeNameAndDebug(flameletVanDriestDelta, 0);
    addToRunTimeSelectionTable(flameletLESdelta, flameletVanDriestDelta, dictionary);
}
}

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::LESModels::flameletVanDriestDelta::calcDelta()
{
...
Foam::LESModels::flameletVanDriestDelta::flameletVanDriestDelta
(
    const word& name,
...
void Foam::LESModels::flameletVanDriestDelta::read(const dictionary& dict)
{
...
void Foam::LESModels::flameletVanDriestDelta::correct()
{
