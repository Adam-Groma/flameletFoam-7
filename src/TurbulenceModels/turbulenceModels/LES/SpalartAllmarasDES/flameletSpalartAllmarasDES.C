...
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::chi() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::fv1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::fv2
(
    const volScalarField& chi,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::S
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::Omega
(
    const volTensorField& gradU
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::Stilda
(
    const volScalarField& chi,
    const volScalarField& fv1,
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::r
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::fw
(
    const volScalarField& Omega,
    const volScalarField& dTilda
) const
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::dTilda
(
    const volScalarField& chi,
    const volScalarField& fv1,
    const volTensorField& gradU
...
template<class BasicTurbulenceModel>
void flameletSpalartAllmarasDES<BasicTurbulenceModel>::correctNut
(
    const volScalarField& fv1
)
{
...
template<class BasicTurbulenceModel>
flameletSpalartAllmarasDES<BasicTurbulenceModel>::flameletSpalartAllmarasDES
(
...
:
    flameletLESeddyViscosity<BasicTurbulenceModel>
    (
        type,
        alpha,
        rho,
...
template<class BasicTurbulenceModel>
bool flameletSpalartAllmarasDES<BasicTurbulenceModel>::read()
{
    if (flameletLESeddyViscosity<BasicTurbulenceModel>::read())
    {
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::
DnuTildaEff() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::k() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasDES<BasicTurbulenceModel>::LESRegion() const
{
    const volScalarField chi(this->chi());
    const volScalarField fv1(this->fv1(chi));
...
template<class BasicTurbulenceModel>
void flameletSpalartAllmarasDES<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    flameletLESeddyViscosity<BasicTurbulenceModel>::correct();
