...
tmp<volScalarField> flameletSpalartAllmarasIDDES<BasicTurbulenceModel>::alpha() const
{
    return max
    (
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasIDDES<BasicTurbulenceModel>::ft
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasIDDES<BasicTurbulenceModel>::fl
(
    const volScalarField& magGradU
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasIDDES<BasicTurbulenceModel>::rd
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasIDDES<BasicTurbulenceModel>::fd
(
    const volScalarField& magGradU
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletSpalartAllmarasIDDES<BasicTurbulenceModel>::dTilda
(
...
template<class BasicTurbulenceModel>
flameletSpalartAllmarasIDDES<BasicTurbulenceModel>::flameletSpalartAllmarasIDDES
(
...
:
    flameletSpalartAllmarasDES<BasicTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicTurbulenceModel>
bool flameletSpalartAllmarasIDDES<BasicTurbulenceModel>::read()
{
    if (flameletSpalartAllmarasDES<BasicTurbulenceModel>::read())
    {
