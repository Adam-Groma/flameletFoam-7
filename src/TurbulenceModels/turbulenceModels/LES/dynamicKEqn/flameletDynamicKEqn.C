...
Foam::tmp<Foam::volScalarField> flameletDynamicKEqn<BasicTurbulenceModel>::KK() const
{
    return max
    (
...
template<class BasicTurbulenceModel>
volScalarField flameletDynamicKEqn<BasicTurbulenceModel>::Ck
(
...
template<class BasicTurbulenceModel>
volScalarField flameletDynamicKEqn<BasicTurbulenceModel>::Ce
(
    const volSymmTensorField& D,
    const volScalarField& KK
) const
...
template<class BasicTurbulenceModel>
volScalarField flameletDynamicKEqn<BasicTurbulenceModel>::Ce() const
{
...
template<class BasicTurbulenceModel>
void flameletDynamicKEqn<BasicTurbulenceModel>::correctNut
(
    const volSymmTensorField& D,
    const volScalarField& KK
)
...
template<class BasicTurbulenceModel>
tmp<fvScalarMatrix> flameletDynamicKEqn<BasicTurbulenceModel>::kSource() const
{
...
template<class BasicTurbulenceModel>
flameletDynamicKEqn<BasicTurbulenceModel>::flameletDynamicKEqn
(
...
template<class BasicTurbulenceModel>
bool flameletDynamicKEqn<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletDynamicKEqn<BasicTurbulenceModel>::epsilon() const
{
...
template<class BasicTurbulenceModel>
void flameletDynamicKEqn<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
