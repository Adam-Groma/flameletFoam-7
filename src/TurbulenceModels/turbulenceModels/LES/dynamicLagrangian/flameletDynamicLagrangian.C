...
void flameletDynamicLagrangian<BasicTurbulenceModel>::correctNut
(
...
template<class BasicTurbulenceModel>
flameletDynamicLagrangian<BasicTurbulenceModel>::flameletDynamicLagrangian
(
...
template<class BasicTurbulenceModel>
bool flameletDynamicLagrangian<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void flameletDynamicLagrangian<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
