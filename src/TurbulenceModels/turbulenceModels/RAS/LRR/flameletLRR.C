...
void flameletLRR<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
flameletLRR<BasicTurbulenceModel>::flameletLRR
(
...
:
    flameletReynoldsStress<flameletRASModel<BasicTurbulenceModel>>
    (
        type,
        alpha,
        rho,
...
template<class BasicTurbulenceModel>
bool flameletLRR<BasicTurbulenceModel>::read()
{
    if (flameletReynoldsStress<flameletRASModel<BasicTurbulenceModel>>::read())
    {
...
template<class BasicTurbulenceModel>
tmp<volSymmTensorField> flameletLRR<BasicTurbulenceModel>::DREff() const
{
...
template<class BasicTurbulenceModel>
tmp<volSymmTensorField> flameletLRR<BasicTurbulenceModel>::DepsilonEff() const
{
    return volSymmTensorField::New
    (
        "DepsilonEff",
...
template<class BasicTurbulenceModel>
void flameletLRR<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    flameletReynoldsStress<flameletRASModel<BasicTurbulenceModel>>::correct();
