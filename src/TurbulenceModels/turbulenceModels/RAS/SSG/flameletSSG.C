...
void flameletSSG<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
flameletSSG<BasicTurbulenceModel>::flameletSSG
(
...
template<class BasicTurbulenceModel>
bool flameletSSG<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
tmp<volSymmTensorField> flameletSSG<BasicTurbulenceModel>::DREff() const
{
...
template<class BasicTurbulenceModel>
tmp<volSymmTensorField> flameletSSG<BasicTurbulenceModel>::DepsilonEff() const
{
    return volSymmTensorField::New
    (
        "DepsilonEff",
...
template<class BasicTurbulenceModel>
void flameletSSG<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
