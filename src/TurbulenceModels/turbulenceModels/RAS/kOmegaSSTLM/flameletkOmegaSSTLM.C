...
tmp<volScalarField> flameletkOmegaSSTLM<BasicTurbulenceModel>::F1
(
...
) const
{
    ...
    return max(flameletkOmegaSST<BasicTurbulenceModel>::F1(CDkOmega), F3);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> flameletkOmegaSSTLM<BasicTurbulenceModel>::Pk
(
    const volScalarField::Internal& G
) const
{
    return gammaIntEff_*flameletkOmegaSST<BasicTurbulenceModel>::Pk(G);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> flameletkOmegaSSTLM<BasicTurbulenceModel>::epsilonByk
(
...
) const
{
    return
       ...
       *flameletkOmegaSST<BasicTurbulenceModel>::epsilonByk(F1, F2);
}


template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> flameletkOmegaSSTLM<BasicTurbulenceModel>::Fthetat
(
...
flameletkOmegaSSTLM<BasicTurbulenceModel>::ReThetac() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> flameletkOmegaSSTLM<BasicTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> flameletkOmegaSSTLM<BasicTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> flameletkOmegaSSTLM<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
flameletkOmegaSSTLM<BasicTurbulenceModel>::flameletkOmegaSSTLM
(
...
:
    flameletkOmegaSST<BasicTurbulenceModel>
    (
        alpha,
        rho,
        U,
...
template<class BasicTurbulenceModel>
bool flameletkOmegaSSTLM<BasicTurbulenceModel>::read()
{
    if (flameletkOmegaSST<BasicTurbulenceModel>::read())
    {
...
template<class BasicTurbulenceModel>
void flameletkOmegaSSTLM<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void flameletkOmegaSSTLM<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
    ...
    // Correct k and omega
    flameletkOmegaSST<BasicTurbulenceModel>::correct();
}
