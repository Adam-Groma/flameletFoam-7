...
tmp<fvScalarMatrix> flameletkOmegaSSTSAS<BasicTurbulenceModel>::Qsas
(
...
template<class BasicTurbulenceModel>
flameletkOmegaSSTSAS<BasicTurbulenceModel>::flameletkOmegaSSTSAS
(
...
template<class BasicTurbulenceModel>
bool flameletkOmegaSSTSAS<BasicTurbulenceModel>::read()
{
