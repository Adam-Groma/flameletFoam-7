...
tmp<volScalarField> flameletv2f<BasicTurbulenceModel>::Ts() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField> flameletv2f<BasicTurbulenceModel>::Ls() const
{
    return
        CL_*max(pow(k_, 1.5)
...
template<class BasicTurbulenceModel>
void flameletv2f<BasicTurbulenceModel>::correctNut()
{
...
template<class BasicTurbulenceModel>
flameletv2f<BasicTurbulenceModel>::flameletv2f
(
...
template<class BasicTurbulenceModel>
bool flameletv2f<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void flameletv2f<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
