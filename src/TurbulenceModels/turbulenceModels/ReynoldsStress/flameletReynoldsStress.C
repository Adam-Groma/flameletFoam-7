...
#include "flameletReynoldsStress.H"
#include "fvc.H"
#include "fvm.H"
...
void Foam::flameletReynoldsStress<BasicTurbulenceModel>::boundNormalStress
(
...
template<class BasicTurbulenceModel>
void Foam::flameletReynoldsStress<BasicTurbulenceModel>::correctWallShearStress
(
    volSymmTensorField& R
) const
{
...
template<class BasicTurbulenceModel>
Foam::flameletReynoldsStress<BasicTurbulenceModel>::flameletReynoldsStress
(
...
template<class BasicTurbulenceModel>
bool Foam::flameletReynoldsStress<BasicTurbulenceModel>::read()
{
...
Foam::flameletReynoldsStress<BasicTurbulenceModel>::R() const
{
    return R_;
}
...
Foam::flameletReynoldsStress<BasicTurbulenceModel>::k() const
{
...
template<class BasicTurbulenceModel>
Foam::tmp<Foam::volSymmTensorField>
Foam::flameletReynoldsStress<BasicTurbulenceModel>::devRhoReff() const
{
...
Foam::flameletReynoldsStress<BasicTurbulenceModel>::DivDevRhoReff
(
...
template<class BasicTurbulenceModel>
void Foam::flameletReynoldsStress<BasicTurbulenceModel>::validate()
{
    correctNut();
}
...
template<class BasicTurbulenceModel>
void Foam::flameletReynoldsStress<BasicTurbulenceModel>::correct()
{
