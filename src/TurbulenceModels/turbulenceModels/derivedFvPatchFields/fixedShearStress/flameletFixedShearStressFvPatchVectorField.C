...
#include "flameletFixedShearStressFvPatchVectorField.H"
...
Foam::flameletFixedShearStressFvPatchVectorField::flameletFixedShearStressFvPatchVectorField
(
    const fvPatch& p,
...
Foam::flameletFixedShearStressFvPatchVectorField::flameletFixedShearStressFvPatchVectorField
(
    const flameletFixedShearStressFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<vector, volMesh>& iF,
...
void Foam::flameletFixedShearStressFvPatchVectorField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::flameletFixedShearStressFvPatchVectorField::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchVectorField,
        flameletFixedShearStressFvPatchVectorField
    );
}
