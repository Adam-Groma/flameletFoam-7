...
#include "flameletPorousBafflePressureFvPatchField.H"
...
Foam::flameletPorousBafflePressureFvPatchField::flameletPorousBafflePressureFvPatchField
(
    const fvPatch& p,
...
Foam::flameletPorousBafflePressureFvPatchField::flameletPorousBafflePressureFvPatchField
(
    const flameletPorousBafflePressureFvPatchField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void Foam::flameletPorousBafflePressureFvPatchField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void Foam::flameletPorousBafflePressureFvPatchField::write(Ostream& os) const
{
...
namespace Foam
{
    ...
    (
        fvPatchScalarField,
        flameletPorousBafflePressureFvPatchField
    );
}
