...
flameletFWallFunctionFvPatchScalarField::flameletFWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
flameletFWallFunctionFvPatchScalarField::flameletFWallFunctionFvPatchScalarField
(
    const flameletFWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
flameletFWallFunctionFvPatchScalarField::flameletFWallFunctionFvPatchScalarField
(
    const flameletFWallFunctionFvPatchScalarField& v2wfpsf
)
:
...
void flameletFWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
(
    fvPatchScalarField,
    flameletFWallFunctionFvPatchScalarField
);
