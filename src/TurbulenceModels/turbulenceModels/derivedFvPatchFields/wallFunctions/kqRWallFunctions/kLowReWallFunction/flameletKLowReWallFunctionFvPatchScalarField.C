...
#include "flameletKLowReWallFunctionFvPatchScalarField.H"
...
flameletKLowReWallFunctionFvPatchScalarField::flameletKLowReWallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
flameletKLowReWallFunctionFvPatchScalarField::flameletKLowReWallFunctionFvPatchScalarField
(
    const flameletKLowReWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
flameletKLowReWallFunctionFvPatchScalarField::flameletKLowReWallFunctionFvPatchScalarField
(
    const flameletKLowReWallFunctionFvPatchScalarField& kwfpsf
)
:
...
void flameletKLowReWallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
void flameletKLowReWallFunctionFvPatchScalarField::write(Ostream& os) const
{
...
(
    fvPatchScalarField,
    flameletKLowReWallFunctionFvPatchScalarField
);
