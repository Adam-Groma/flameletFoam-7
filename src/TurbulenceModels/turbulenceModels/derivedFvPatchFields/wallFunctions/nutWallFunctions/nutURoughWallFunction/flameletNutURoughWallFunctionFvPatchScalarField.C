...
#include "flameletNutURoughWallFunctionFvPatchScalarField.H"
...
tmp<scalarField> flameletNutURoughWallFunctionFvPatchScalarField::nut() const
{
...
tmp<scalarField> flameletNutURoughWallFunctionFvPatchScalarField::yPlus
(
...
flameletNutURoughWallFunctionFvPatchScalarField::flameletNutURoughWallFunctionFvPatchScalarField
(
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF
)
:
    flameletNutUWallFunctionFvPatchScalarField(p, iF),
    Ks_(p.size(), 0.0),
    Cs_(p.size(), 0.0)
{}
...
:
    flameletNutUWallFunctionFvPatchScalarField(p, iF, dict),
    Ks_("Ks", dict, p.size()),
    Cs_("Cs", dict, p.size())
{}
...
flameletNutURoughWallFunctionFvPatchScalarField::flameletNutURoughWallFunctionFvPatchScalarField
(
    const flameletNutURoughWallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
    const fvPatchFieldMapper& mapper
)
:
    flameletNutUWallFunctionFvPatchScalarField(ptf, p, iF, mapper),
    Ks_(mapper(ptf.Ks_)),
    Cs_(mapper(ptf.Cs_))
{}
...
flameletNutURoughWallFunctionFvPatchScalarField::flameletNutURoughWallFunctionFvPatchScalarField
(
    const flameletNutURoughWallFunctionFvPatchScalarField& rwfpsf
)
:
    flameletNutUWallFunctionFvPatchScalarField(rwfpsf),
    Ks_(rwfpsf.Ks_),
    Cs_(rwfpsf.Cs_)
{}
...
:
    flameletNutUWallFunctionFvPatchScalarField(rwfpsf, iF),
    Ks_(rwfpsf.Ks_),
    Cs_(rwfpsf.Cs_)
{}
...
void flameletNutURoughWallFunctionFvPatchScalarField::autoMap
(
    const fvPatchFieldMapper& m
)
{
    flameletNutUWallFunctionFvPatchScalarField::autoMap(m);
    m(Ks_, Ks_);
    m(Cs_, Cs_);
}


void flameletNutURoughWallFunctionFvPatchScalarField::rmap
(
    const fvPatchScalarField& ptf,
    const labelList& addr
)
{
    flameletNutUWallFunctionFvPatchScalarField::rmap(ptf, addr);

    const flameletNutURoughWallFunctionFvPatchScalarField& nrwfpsf =
        refCast<const flameletNutURoughWallFunctionFvPatchScalarField>(ptf);
...
void flameletNutURoughWallFunctionFvPatchScalarField::write(Ostream& os) const
{
...
(
    fvPatchScalarField,
    flameletNutURoughWallFunctionFvPatchScalarField
);
