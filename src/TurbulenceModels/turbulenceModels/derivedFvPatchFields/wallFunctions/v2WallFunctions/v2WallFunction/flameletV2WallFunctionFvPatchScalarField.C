...
#include "flameletV2WallFunctionFvPatchScalarField.H"
...
flameletV2WallFunctionFvPatchScalarField::flameletV2WallFunctionFvPatchScalarField
(
    const fvPatch& p,
...
flameletV2WallFunctionFvPatchScalarField::flameletV2WallFunctionFvPatchScalarField
(
    const flameletV2WallFunctionFvPatchScalarField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
flameletV2WallFunctionFvPatchScalarField::flameletV2WallFunctionFvPatchScalarField
(
    const flameletV2WallFunctionFvPatchScalarField& v2wfpsf
)
:
...
void flameletV2WallFunctionFvPatchScalarField::updateCoeffs()
{
    if (updated())
    {
        return;
...
(
    fvPatchScalarField,
    flameletV2WallFunctionFvPatchScalarField
);
