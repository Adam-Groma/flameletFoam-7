...
#include "flameletEddyViscosity.H"
#include "fvc.H"
#include "fvm.H"
...
Foam::flameletEddyViscosity<BasicTurbulenceModel>::flameletEddyViscosity
(
    const word& type,
...
:
    flameletLinearViscousStress<BasicTurbulenceModel>
    (
        type,
        alpha,
        rho,
...
template<class BasicTurbulenceModel>
bool Foam::flameletEddyViscosity<BasicTurbulenceModel>::read()
{
...
Foam::flameletEddyViscosity<BasicTurbulenceModel>::R() const
{
...
template<class BasicTurbulenceModel>
void Foam::flameletEddyViscosity<BasicTurbulenceModel>::validate()
{
    correctNut();
}
...
template<class BasicTurbulenceModel>
void Foam::flameletEddyViscosity<BasicTurbulenceModel>::correct()
{
