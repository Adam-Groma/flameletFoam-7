...
tmp<fvSymmTensorMatrix> flameletMaxwell<BasicTurbulenceModel>::sigmaSource() const
{
...
template<class BasicTurbulenceModel>
flameletMaxwell<BasicTurbulenceModel>::flameletMaxwell
(
...
:
    flameletLaminarModel<BasicTurbulenceModel>
    (
        type,
        alpha,
        rho,
...
template<class BasicTurbulenceModel>
bool flameletMaxwell<BasicTurbulenceModel>::read()
{
    if (LflameletaminarModel<BasicTurbulenceModel>::read())
    {
...
flameletMaxwell<BasicTurbulenceModel>::R() const
{
    return sigma_;
}
...
template<class BasicTurbulenceModel>
tmp<Foam::volSymmTensorField>
flameletMaxwell<BasicTurbulenceModel>::devRhoReff() const
{
...
flameletMaxwell<BasicTurbulenceModel>::divDevRhoReff
(
    volVectorField& U
) const
{
...
template<class BasicTurbulenceModel>
void flameletMaxwell<BasicTurbulenceModel>::correct()
{
    // Local references
