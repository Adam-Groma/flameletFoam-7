...
{
    defineTypeNameAndDebug(flameletBirdCarreau, 0);
...
Foam::laminarModels::generalizedNewtonianViscosityModels::flameletBirdCarreau::
flameletBirdCarreau
(
...
bool Foam::laminarModels::generalizedNewtonianViscosityModels::flameletBirdCarreau::
read
(
    const dictionary& viscosityProperties
)
