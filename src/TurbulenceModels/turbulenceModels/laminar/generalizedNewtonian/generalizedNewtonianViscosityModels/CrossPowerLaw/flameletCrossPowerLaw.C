...
#include "flameletCrossPowerLaw.H"
#include "volFields.H"
...
{
    defineTypeNameAndDebug(flameletCrossPowerLaw, 0);

    addToRunTimeSelectionTable
    (
        flameletGeneralizedNewtonianViscosityModel,
        flameletCrossPowerLaw,
        dictionary
    );
}
}
...
Foam::laminarModels::generalizedNewtonianViscosityModels::flameletCrossPowerLaw::
flameletCrossPowerLaw
(
...
bool Foam::laminarModels::generalizedNewtonianViscosityModels::flameletCrossPowerLaw::
read
(
    const dictionary& viscosityProperties
)
