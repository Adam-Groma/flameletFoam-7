...
#include "flameletHerschelBulkley.H"
#include "volFields.H"
...
{
    defineTypeNameAndDebug(flameletHerschelBulkley, 0);

    addToRunTimeSelectionTable
    (
        flameletGeneralizedNewtonianViscosityModel,
        flameletHerschelBulkley,
        dictionary
    );
}
}
...
Foam::laminarModels::generalizedNewtonianViscosityModels::flameletHerschelBulkley::
flameletHerschelBulkley
(
