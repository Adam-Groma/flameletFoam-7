...
{
    defineTypeNameAndDebug(flameletPowerLaw, 0);
...
Foam::laminarModels::generalizedNewtonianViscosityModels::flameletPowerLaw::flameletPowerLaw
(
...
bool Foam::laminarModels::generalizedNewtonianViscosityModels::flameletPowerLaw::read
(
    const dictionary& viscosityProperties
)
{
...
Foam::laminarModels::generalizedNewtonianViscosityModels::flameletPowerLaw::
nu
(
