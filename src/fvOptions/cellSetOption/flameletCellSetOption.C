...
#include "flameletCellSetOption.H"
#include "volFields.H"
...
namespace Foam
{
    namespace fv
    {
        defineTypeNameAndDebug(flameletCellSetOption, 0);
    }

    template<> const char* NamedEnum
    <
        fv::flameletCellSetOption::selectionModeType,
        4
        >::names[] =
    {
        "points",
    ...
    const NamedEnum<fv::flameletCellSetOption::selectionModeType, 4>
        fv::flameletCellSetOption::selectionModeTypeNames_;
}


// * * * * * * * * * * * * Protected Member Functions  * * * * * * * * * * * //

void Foam::fv::flameletCellSetOption::setSelection(const dictionary& dict)
{
...
void Foam::fv::flameletCellSetOption::setCellSet()
{
    switch (selectionMode_)
    {
        case smPoints:
...
Foam::fv::flameletCellSetOption::flameletCellSetOption
(
    const word& name,
...
bool Foam::fv::flameletCellSetOption::isActive()
{
