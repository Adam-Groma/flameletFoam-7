...
#include "flameletLimitVelocity.H"
#include "volFields.H"
...
namespace fv
{
    defineTypeNameAndDebug(flameletLimitVelocity, 0);
    addToRunTimeSelectionTable
    (
        option,
        flameletLimitVelocity,
        dictionary
    );
}
}
...
Foam::fv::flameletLimitVelocity::flameletLimitVelocity
(
    const word& name,
...
bool Foam::fv::flameletLimitVelocity::read(const dictionary& dict)
{
...
void Foam::fv::flameletLimitVelocity::correct(volVectorField& U)
{
