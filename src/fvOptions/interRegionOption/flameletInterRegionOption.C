...
#include "flameletInterRegionOption.H"
...
namespace fv
{
    defineTypeNameAndDebug(flameletInterRegionOption, 0);
}
}
...
void Foam::fv::flameletInterRegionOption::setMapper()
{
    if (master_)
    {
...
Foam::fv::flameletInterRegionOption::flameletInterRegionOption
(
    const word& name,
