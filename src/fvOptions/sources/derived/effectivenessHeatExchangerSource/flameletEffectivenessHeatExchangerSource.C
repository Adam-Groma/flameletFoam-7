...
#include "flameletEffectivenessHeatExchangerSource.H"
#include "fvMesh.H"
#include "fvMatrix.H"
...
namespace fv
{
    defineTypeNameAndDebug(flameletEffectivenessHeatExchangerSource, 0);
    addToRunTimeSelectionTable
    (
        option,
        flameletEffectivenessHeatExchangerSource,
        dictionary
    );
}
}
...
void Foam::fv::flameletEffectivenessHeatExchangerSource::initialise()
{
...
void Foam::fv::flameletEffectivenessHeatExchangerSource::calculateTotalArea
(
    scalar& area
)
{
...
Foam::fv::flameletEffectivenessHeatExchangerSource::flameletEffectivenessHeatExchangerSource
(
    const word& name,
...
void Foam::fv::flameletEffectivenessHeatExchangerSource::addSup
(
...
bool Foam::fv::flameletEffectivenessHeatExchangerSource::read(const dictionary& dict)
{
