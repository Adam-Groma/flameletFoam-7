...
#include "flameletMeanVelocityForce.H"
...
namespace fv
{
    defineTypeNameAndDebug(flameletMeanVelocityForce, 0);

    addToRunTimeSelectionTable
    (
        option,
        flameletMeanVelocityForce,
        dictionary
    );
}
}
...
void Foam::fv::flameletMeanVelocityForce::writeProps
(
    const scalar gradP
) const
{
...
Foam::fv::flameletMeanVelocityForce::flameletMeanVelocityForce
(
...
Foam::scalar Foam::fv::flameletMeanVelocityForce::magUbarAve
(
...
void Foam::fv::flameletMeanVelocityForce::correct(volVectorField& U)
{
...
void Foam::fv::flameletMeanVelocityForce::addSup
(
    fvMatrix<vector>& eqn,
    const label fieldi
)
...
void Foam::fv::flameletMeanVelocityForce::constrain
(
    fvMatrix<vector>& eqn,
    const label
)
