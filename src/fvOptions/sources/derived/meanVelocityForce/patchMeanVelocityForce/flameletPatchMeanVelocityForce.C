...
#include "flameletPatchMeanVelocityForce.H"
...
namespace fv
{
    defineTypeNameAndDebug(flameletPatchMeanVelocityForce, 0);

    addToRunTimeSelectionTable
    (
        option,
        flameletPatchMeanVelocityForce,
        dictionary
    );
}
}
...
Foam::fv::flameletPatchMeanVelocityForce::flameletPatchMeanVelocityForce
(
...
:
    flameletMeanVelocityForce(sourceName, modelType, dict, mesh),
...
Foam::scalar Foam::fv::flameletPatchMeanVelocityForce::magUbarAve
(
