...
template<class Type>
Foam::fv::FlameletPhaseLimitStabilization<Type>::FlameletPhaseLimitStabilization
(
    const word& name,
...
template<class Type>
void Foam::fv::FlameletPhaseLimitStabilization<Type>::addSup
(
...
template<class Type>
bool Foam::fv::FlameletPhaseLimitStabilization<Type>::read(const dictionary& dict)
{
    if (option::read(dict))
    {
