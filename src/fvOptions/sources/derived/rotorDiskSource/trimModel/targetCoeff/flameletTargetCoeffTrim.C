...
#include "flameletTargetCoeffTrim.H"
...
namespace Foam
{
    defineTypeNameAndDebug(flameletTargetCoeffTrim, 0);

    addToRunTimeSelectionTable(flameletTrimModel, flameletTargetCoeffTrim, dictionary);
}
...
Foam::vector Foam::flameletTargetCoeffTrim::calcCoeffs
(
...
template<class RhoFieldType>
void Foam::flameletTargetCoeffTrim::correctTrim
(
    const RhoFieldType& rho,
    const vectorField& U,
    vectorField& force
...
Foam::flameletTargetCoeffTrim::flameletTargetCoeffTrim
(
...
void Foam::flameletTargetCoeffTrim::read(const dictionary& dict)
{
...
Foam::tmp<Foam::scalarField> Foam::flameletTargetCoeffTrim::thetag() const
{
...
void Foam::flameletTargetCoeffTrim::correct
(
    const vectorField& U,
    vectorField& force
)
