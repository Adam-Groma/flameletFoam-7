...
#include "flameletSolidEqulibriumEnergySource.H"
#include "fvmDdt.H"
...
namespace fv
{
    defineTypeNameAndDebug(flameletSolidEqulibriumEnergySource, 0);
    addToRunTimeSelectionTable
    (
        option,
        flameletSolidEqulibriumEnergySource,
        dictionary
    );
}
}
...
const Foam::volScalarField& Foam::fv::flameletSolidEqulibriumEnergySource::alpha() const
{
...
const Foam::solidThermo& Foam::fv::flameletSolidEqulibriumEnergySource::thermo() const
{
...
Foam::fv::flameletSolidEqulibriumEnergySource::flameletSolidEqulibriumEnergySource
(
    const word& name,
...
void Foam::fv::flameletSolidEqulibriumEnergySource::addSup
(
...
bool Foam::fv::flameletSolidEqulibriumEnergySource::read(const dictionary& dict)
{
    if (option::read(dict))
    {
