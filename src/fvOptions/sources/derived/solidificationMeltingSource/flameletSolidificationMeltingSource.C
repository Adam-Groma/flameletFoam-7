...
#include "flameletSolidificationMeltingSource.H"
...
namespace Foam
{
    ...
    <
        fv::flameletSolidificationMeltingSource::thermoMode,
        2
    >::names[] =
    {
        "thermo",
    ...
    namespace fv
    {
        defineTypeNameAndDebug(flameletSolidificationMeltingSource, 0);

        addToRunTimeSelectionTable
        (
            option,
            flameletSolidificationMeltingSource,
            dictionary
        );
    }
}

const Foam::NamedEnum<Foam::fv::flameletSolidificationMeltingSource::thermoMode, 2>
    Foam::fv::flameletSolidificationMeltingSource::thermoModeTypeNames_;


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

Foam::tmp<Foam::volScalarField>
Foam::fv::flameletSolidificationMeltingSource::Cp() const
{
    switch (mode_)
    {
        case mdThermo:
        {
            const flameletBasicThermo& thermo =
                mesh_.lookupObject<flameletBasicThermo>(flameletBasicThermo::dictName);
...
Foam::vector Foam::fv::flameletSolidificationMeltingSource::g() const
{
...
void Foam::fv::flameletSolidificationMeltingSource::update(const volScalarField& Cp)
{
...
Foam::fv::flameletSolidificationMeltingSource::flameletSolidificationMeltingSource
(
...
:
    flameletCellSetOption(sourceName, modelType, dict, mesh),
...
void Foam::fv::flameletSolidificationMeltingSource::addSup
(
    fvMatrix<scalar>& eqn,
    const label fieldi
)
