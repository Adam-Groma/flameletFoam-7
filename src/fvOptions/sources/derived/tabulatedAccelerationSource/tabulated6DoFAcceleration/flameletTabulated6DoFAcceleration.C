...
#include "flameletTabulated6DoFAcceleration.H"
#include "Tuple2.H"
#include "IFstream.H"
...
namespace Foam
{
    defineTypeNameAndDebug(flameletTabulated6DoFAcceleration, 0);
}


// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::flameletTabulated6DoFAcceleration::flameletTabulated6DoFAcceleration
(
...
Foam::flameletTabulated6DoFAcceleration::accelerationVectors
Foam::flameletTabulated6DoFAcceleration::acceleration() const
{
...
bool Foam::flameletTabulated6DoFAcceleration::read
(
    const dictionary& accelerationCoeffs
)
{
