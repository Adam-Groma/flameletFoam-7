...
#include "FlameletSemiImplicitSource.H"
#include "fvMesh.H"
...
template<class Type>
const Foam::wordList Foam::fv::FlameletSemiImplicitSource<Type>::volumeModeTypeNames_
(
...
template<class Type>
typename Foam::fv::FlameletSemiImplicitSource<Type>::volumeModeType
Foam::fv::FlameletSemiImplicitSource<Type>::wordToVolumeModeType
(
    const word& vmtName
) const
{
...
template<class Type>
Foam::word Foam::fv::FlameletSemiImplicitSource<Type>::volumeModeTypeToWord
(
...
template<class Type>
void Foam::fv::FlameletSemiImplicitSource<Type>::setFieldData(const dictionary& dict)
{
...
template<class Type>
Foam::fv::FlameletSemiImplicitSource<Type>::FlameletSemiImplicitSource
(
    const word& name,
...
template<class Type>
void Foam::fv::FlameletSemiImplicitSource<Type>::addSup
(
    fvMatrix<Type>& eqn,
    const label fieldi
)
{
    if (debug)
    {
        Info<< "FlameletSemiImplicitSource<" << pTraits<Type>::typeName
