...
Foam::fv::flameletInterRegionHeatTransferModel::interpolate
(
    const flameletInterRegionHeatTransferModel& nbrModel,
...
template<class Type>
void Foam::fv::flameletInterRegionHeatTransferModel::interpolate
(
    const flameletInterRegionHeatTransferModel& nbrModel,
    const Field<Type>& field,
    Field<Type>& result
