...
#include "flameletTabulatedHeatTransfer.H"
...
namespace fv
{
    defineTypeNameAndDebug(flameletTabulatedHeatTransfer, 0);
    addToRunTimeSelectionTable
    (
        option,
        flameletTabulatedHeatTransfer,
        dictionary
    );
}
}
...
Foam::fv::flameletTabulatedHeatTransfer::hTable()
{
    if (!hTable_.valid())
    {
...
const Foam::volScalarField& Foam::fv::flameletTabulatedHeatTransfer::AoV()
{
    if (!AoV_.valid())
    {
        AoV_.reset
...
Foam::fv::flameletTabulatedHeatTransfer::flameletTabulatedHeatTransfer
(
    const word& name,
...
void Foam::fv::flameletTabulatedHeatTransfer::calculateHtc()
{
...
bool Foam::fv::flameletTabulatedHeatTransfer::read(const dictionary& dict)
{
