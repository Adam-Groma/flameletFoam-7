...
void Foam::flameletHeThermo<BasicThermo, MixtureType>::
heBoundaryCorrection(volScalarField& h)
{
    ...
    forAll(hBf, patchi)
    {
        if (isA<flameletGradientEnergyFvPatchScalarField>(hBf[patchi]))
        {
            refCast<flameletGradientEnergyFvPatchScalarField>(hBf[patchi]).gradient()
                = hBf[patchi].fvPatchField::snGrad();
        }
        else if (isA<flameletMixedEnergyFvPatchScalarField>(hBf[patchi]))
        {
            refCast<flameletMixedEnergyFvPatchScalarField>(hBf[patchi]).refGrad()
                = hBf[patchi].fvPatchField::snGrad();
        }
    }
}
...
template<class BasicThermo, class MixtureType>
void Foam::flameletHeThermo<BasicThermo, MixtureType>::init()
{
...
template<class BasicThermo, class MixtureType>
Foam::flameletHeThermo<BasicThermo, MixtureType>::flameletHeThermo
(
    const fvMesh& mesh,
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::he
(
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::he
(
    const scalarField& p,
    const scalarField& T,
...
Foam::flameletHeThermo<BasicThermo, MixtureType>::hc() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::Cp
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::Cp() const
{
    const fvMesh& mesh = this->T_.mesh();
...
Foam::flameletHeThermo<BasicThermo, MixtureType>::Cv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::Cv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::gamma
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::gamma() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::Cpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::Cpv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::CpByCpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::CpByCpv() const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::THE
(
    const scalarField& h,
    const scalarField& p,
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::W
(
) const
{
    const fvMesh& mesh = this->T_.mesh();
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::W
(
    const label patchi
) const
{
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::kappa() const
{
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField> Foam::flameletHeThermo<BasicThermo, MixtureType>::kappa
(
    const label patchi
) const
{
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::alphahe() const
{
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::scalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::alphahe(const label patchi) const
{
    return
    this->CpByCpv
    (
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::kappaEff
(
...
template<class BasicThermo, class MixtureType>
Foam::tmp<Foam::volScalarField>
Foam::flameletHeThermo<BasicThermo, MixtureType>::alphaEff
(
    const volScalarField& alphat
) const
{
...
template<class BasicThermo, class MixtureType>
bool Foam::flameletHeThermo<BasicThermo, MixtureType>::read()
{
    if (BasicThermo::read())
    {
