...
Foam::flameletPengRobinsonGas<Specie>::flameletPengRobinsonGas
(
...
template<class Specie>
void Foam::flameletPengRobinsonGas<Specie>::write(Ostream& os) const
{
    Specie::write(os);
}
...
(
    Ostream& os,
    const flameletPengRobinsonGas<Specie>& pg
)
{
    pg.write(os);
    return os;
