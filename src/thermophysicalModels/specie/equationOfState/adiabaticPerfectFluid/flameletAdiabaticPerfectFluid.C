...
Foam::flameletAdiabaticPerfectFluid<Specie>::flameletAdiabaticPerfectFluid
(
...
template<class Specie>
void Foam::flameletAdiabaticPerfectFluid<Specie>::write(Ostream& os) const
{
    Specie::write(os);
...
(
    Ostream& os,
    const flameletAdiabaticPerfectFluid<Specie>& pf
)
{
    pf.write(os);
    return os;
