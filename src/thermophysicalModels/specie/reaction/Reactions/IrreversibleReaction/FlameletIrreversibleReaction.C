...
<
    ...
    class ReactionRate
>
Foam::FlameletIrreversibleReaction<ReactionType, ReactionThermo, ReactionRate>::
...
FlameletIrreversibleReaction
(
    const FlameletIrreversibleReaction<ReactionType, ReactionThermo,ReactionRate>& irr,
    const flameletSpeciesTable& species
)
:
...
<
    ...
    class ReactionRate
>
Foam::scalar Foam::FlameletIrreversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
...
Foam::FlameletIrreversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
...
<
    ...
    class ReactionRate
>
void Foam::FlameletIrreversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
...
<
    ...
    class ReactionRate
>
void Foam::FlameletIrreversibleReaction<ReactionType, ReactionThermo, ReactionRate>::
write
(
    Ostream& os
) const
