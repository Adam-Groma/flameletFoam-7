...
<
    ...
    class ReactionRate
>
Foam::FlameletNonEquilibriumReversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
>::
FlameletNonEquilibriumReversibleReaction
(
...
FlameletNonEquilibriumReversibleReaction
(
    const FlameletNonEquilibriumReversibleReaction
    <
        ReactionType,
        ReactionThermo,
        ReactionRate
...
<
    ...
    class ReactionRate
>
void Foam::FlameletNonEquilibriumReversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
...
<
    ...
    class ReactionRate
>
Foam::scalar Foam::FlameletNonEquilibriumReversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
