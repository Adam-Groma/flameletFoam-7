...
Foam::label Foam::FlameletReaction<ReactionThermo>::nUnNamedReactions(0);

template<class ReactionThermo>
Foam::scalar Foam::FlameletReaction<ReactionThermo>::TlowDefault(0);

template<class ReactionThermo>
Foam::scalar Foam::FlameletReaction<ReactionThermo>::ThighDefault(great);


// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

template<class ReactionThermo>
Foam::label Foam::FlameletReaction<ReactionThermo>::getNewReactionID()
{
...
template<class ReactionThermo>
void Foam::FlameletReaction<ReactionThermo>::setThermo
(
...
template<class ReactionThermo>
Foam::FlameletReaction<ReactionThermo>::FlameletReaction
(
...
Foam::FlameletReaction<ReactionThermo>::New
(
    const flameletSpeciesTable& species,
    const HashPtrTable<ReactionThermo>& thermoDatabase,
    const dictionary& dict
...
template<class ReactionThermo>
void Foam::FlameletReaction<ReactionThermo>::write(Ostream& os) const
{
    ...
    (
        os,
        "reaction",
        flameletSpecieCoeffs::reactionStr(reaction, species_, lhs_, rhs_)
    );
}


template<class ReactionThermo>
void Foam::FlameletReaction<ReactionThermo>::ddot
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo>
void Foam::FlameletReaction<ReactionThermo>::fdot
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo>
void Foam::FlameletReaction<ReactionThermo>::omega
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo>
Foam::scalar Foam::FlameletReaction<ReactionThermo>::omega
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo>
void Foam::FlameletReaction<ReactionThermo>::dwdc
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo>
void Foam::FlameletReaction<ReactionThermo>::dwdT
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo>
const Foam::flameletSpeciesTable& Foam::FlameletReaction<ReactionThermo>::species() const
{
    return species_;
}
