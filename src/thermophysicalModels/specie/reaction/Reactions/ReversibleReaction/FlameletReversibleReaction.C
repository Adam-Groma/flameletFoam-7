...
<
    ...
    class ReactionRate
>
Foam::FlameletReversibleReaction<ReactionType, ReactionThermo, ReactionRate>::
FlameletReversibleReaction
(
...
FlameletReversibleReaction
(
    const FlameletReversibleReaction<ReactionType, ReactionThermo, ReactionRate>& rr,
    const flameletSpeciesTable& species
)
:
...
<
    ...
    class ReactionRate
>
Foam::scalar Foam::FlameletReversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
...
Foam::FlameletReversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
...
<
    ...
    class ReactionRate
>
void Foam::FlameletReversibleReaction
<
    ReactionType,
    ReactionThermo,
    ReactionRate
...
{
    FlameletReaction<ReactionThermo>::write(os);
    k_.write(os);
}
