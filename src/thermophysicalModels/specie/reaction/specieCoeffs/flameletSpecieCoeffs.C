...
#include "flameletSpecieCoeffs.H"
...
Foam::flameletSpecieCoeffs::flameletSpecieCoeffs
(
...
void Foam::flameletSpecieCoeffs::setLRhs
(
    Istream& is,
    const flameletSpeciesTable& species,
    List<flameletSpecieCoeffs>& lhs,
    List<flameletSpecieCoeffs>& rhs
)
{
    DynamicList<flameletSpecieCoeffs> dlrhs;

    while (is.good())
    {
        dlrhs.append(flameletSpecieCoeffs(species, is));
...
void Foam::flameletSpecieCoeffs::reactionStr
(
    OStringStream& reaction,
    const flameletSpeciesTable& species,
    const List<flameletSpecieCoeffs>& scs
)
{
...
Foam::string Foam::flameletSpecieCoeffs::reactionStr
(
    OStringStream& reaction,
    const flameletSpeciesTable& species,
