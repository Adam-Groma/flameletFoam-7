...
Foam::flameletHPolynomialThermo<EquationOfState, PolySize>::flameletHPolynomialThermo
(
...
template<class EquationOfState, int PolySize>
void Foam::flameletHPolynomialThermo<EquationOfState, PolySize>::write
(
    Ostream& os
) const
{
...
(
    Ostream& os,
    const flameletHPolynomialThermo<EquationOfState, PolySize>& pt
)
{
    pt.write(os);
    return os;
