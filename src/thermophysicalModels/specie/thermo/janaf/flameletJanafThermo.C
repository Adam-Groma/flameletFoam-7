...
void Foam::flameletJanafThermo<EquationOfState>::checkInputData() const
{
    if (Tlow_ >= Thigh_)
    {
...
template<class EquationOfState>
Foam::flameletJanafThermo<EquationOfState>::flameletJanafThermo(const dictionary& dict)
:
...
template<class EquationOfState>
void Foam::flameletJanafThermo<EquationOfState>::write(Ostream& os) const
{
...
(
    Ostream& os,
    const flameletJanafThermo<EquationOfState>& jt
)
{
    jt.write(os);
    return os;
