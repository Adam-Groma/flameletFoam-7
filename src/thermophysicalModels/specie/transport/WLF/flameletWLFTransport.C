...
Foam::scalar Foam::flameletWLFTransport<Thermo>::readCoeff
(
...
template<class Thermo>
Foam::flameletWLFTransport<Thermo>::flameletWLFTransport(const dictionary& dict)
:
    Thermo(dict),
...
template<class Thermo>
void Foam::flameletWLFTransport<Thermo>::write(Ostream& os) const
{
...
(
    Ostream& os,
    const flameletWLFTransport<Thermo>& wlft
)
{
    wlft.write(os);
    return os;
